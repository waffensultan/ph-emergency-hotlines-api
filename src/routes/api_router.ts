...
api_router.get("/", (_, res: Response) => {
    res.json({
        ...
        example:
            "Usage: http://ph-emergency-hotlines-api.onrender.com/api/{region}/{province}/{city_or_municipality}?hotline={hotline}",
        hotline_type_values:
            "general, police, medical, rescue_disaster, earthquake_seismic, traffic, social, and digital",
